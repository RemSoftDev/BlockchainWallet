...
namespace Wallet.Migrations
{
    ...
    [Migration("20180829212325_lastBlockWallet2")]
    partial class lastBlockWallet2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Wallet.Models.ChainBlock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("ChainBlock");
                });

            modelBuilder.Entity("Wallet.Models.ChainTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasIndex("ChainBlockId");

                    b.ToTable("ChainTransaction");
                });
            ...
            modelBuilder.Entity("Wallet.Models.LastWalletBlock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Wallet.Models.TransactionMod", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Wallet.Models.ChainTransaction", b =>
                {
                    b.HasOne("Wallet.Models.ChainBlock", "Block")
                        .WithMany("Transactions")
                        .HasForeignKey("ChainBlockId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
